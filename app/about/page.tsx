...
const page = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <main className="max-w-xl m-3 md:m-8 z-50 w-full space-y-8 border rounded-xl border-gray-700/50 p-5 sm:p-10
      ...
      <Button variant="ghost" className="hover:bg-black hover:text-white rounded-full duration-300 mb-5 cursor-pointer">
        ...
        <div className="space-y-6 ">
          ...
          <div className="space-y-4 text-neutral-200 text-pretty tracking-tight">
            <p>I'm Waqar Ahmed — a Computer Science undergraduate and Full Stack Web Developer with a focus on the MERN Stack. I enjoy building fast, scalable web applications that prioritize clean code, modern design, and great user experience.
...
💼  Professional Experience</h2>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-neutral-400 ">Freelance Agency on Fiverr - Remote , 2023 - Present <br />- Founded and run a multi-service freelance agency on Fiverr, providing web development, e-commerce, AI chatbot, and graphic design solutions. <br />
- Handle projects end-to-end, ensuring timely delivery and high client satisfaction. </p>
            </div>
            <div>
