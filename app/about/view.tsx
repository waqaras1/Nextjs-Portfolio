...
const PageView = () => {
  ...
  const education = {
    ...
    period: "2022 - 2026",
    location: "Pakistan",
    description: "Currently pursuing my undergraduate degree in Computer Science with focus on software engineering and web development."
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl space-y-8 p-6 sm:p-10">
        <Navigation title="About Me" showBack={true} />
