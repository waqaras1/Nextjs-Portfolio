...
const SiSupabase = dynamic(() => import("react-icons/si").then(mod => ({ default: mod.SiSupabase })), { ssr: false });
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 pr-32">
              ...
              <div className="grid grid-cols-4 gap-2">
                {menuItems.map((item) => (
                  ...
                  >
                    <Card className="p-3 h-full hover:scale-[1.02] transition-all duration-300 group cursor-pointer">
                      <div className="space-y-0.5">
                        <div className="flex items-center justify-between">
                          ...
                          <Suspense fallback={<IconFallback />}>
                            <BiChevronRight className="text-sm text-gray-300 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300" />
                          </Suspense>
                        </div>
          ...
          <Card variant="glass" className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="text-center p-3 rounded-lg border border-gray-700/30 bg-black/20 hover:bg-blue-500/10 hover:border-blue-500/30 transition-all duration-300 group">
                <Suspense fallback={<IconFallback />}>
                  <SiDocker className="w-6 h-6 mx-auto mb-2 text-blue-400 group-hover:scale-110 transition-transform" />
                </Suspense>
                <div className="text-xs font-medium text-gray-300">Docker</div>
              </div>
              <div className="text-center p-3 rounded-lg border border-gray-700/30 bg-black/20 hover:bg-cyan-500/10 hover:border-cyan-500/30 transition-all duration-300 group">
                <Suspense fallback={<IconFallback />}>
              ...
              <div className="text-center p-3 rounded-lg border border-gray-700/30 bg-black/20 hover:bg-green-500/10 hover:border-green-500/30 transition-all duration-300 group">
                <Suspense fallback={<IconFallback />}>
                  <SiSupabase className="w-6 h-6 mx-auto mb-2 text-green-400 group-hover:scale-110 transition-transform" />
                </Suspense>
                <div className="text-xs font-medium text-gray-300">Supabase</div>
              </div>
            </div>
          </Card>
