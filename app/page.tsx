        ...
        <div className="space-y-4">
          ...
          <Card variant="glass" className="p-6">
            <p className="text-pretty tracking-tight text-gray-300 leading-relaxed">
              Hi, I&apos;m Waqar — a Backend Developer at Aykays specializing in designing and building scalable, secure, and high-performance systems using Node.js, Express.js, and PostgreSQL. I also bring full-stack expertise with React.js and Next.js, enabling me to deliver well-integrated, user-centric solutions. Based in Karachi, Pakistan, I&apos;m passionate about crafting APIs, microservices, and cloud-based applications that solve real-world problems.
            </p>
          </Card>
