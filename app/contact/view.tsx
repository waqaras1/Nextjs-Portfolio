...
const PageView = () => {
  ...
  const contactInfo = [
    ...
    { icon: BiPhone, title: "Phone", value: "+92 335 3015026", href: "tel:+923353015026", color: "text-sky-400" },
    { icon: BiMapPin, title: "Location", value: "Islamabad, Pakistan", href: "#", color: "text-blue-400" }
  ];
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Usually within 2 hours</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2 space-y-6">
                ...
                <Button asChild variant="outline" className="w-full h-14 border-green-500/30 bg-green-500/10 text-gray-300 hover:bg-green-500/20 hover:border-green-500/50 hover:text-white transition-all duration-300">
                  <a href="https://wa.me/923353015026" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
