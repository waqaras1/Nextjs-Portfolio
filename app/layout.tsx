...
export const metadata: Metadata = {
  title: "Waqar Ahmed - Full-Stack Software Engineer | Frontend & Backend Developer in Karachi",
  description: "Professional portfolio of Waqar Ahmed, a Full-Stack Software Engineer at Aykays based in Karachi, Pakistan. Specializing in React.js, Next.js, TypeScript, Node.js, Express.js, PostgreSQL, and modern web development. View my projects and get in touch for collaboration.",
  keywords: [
    "Waqar Ahmed", 
  ...
  openGraph: {
    ...
    title: "Waqar Ahmed - Full-Stack Software Engineer | Frontend & Backend Developer in Karachi",
    description: "Professional portfolio of Waqar Ahmed, a Full-Stack Software Engineer at Aykays based in Karachi, Pakistan. Specializing in React.js, Next.js, TypeScript, Node.js, Express.js, PostgreSQL, and modern web development.",
