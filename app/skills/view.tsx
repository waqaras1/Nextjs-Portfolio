      ...
      <Card className="w-full max-w-4xl space-y-8 p-6 sm:p-10">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            I&apos;m proficient in a variety of modern web technologies, from frontend frameworks to backend systems and databases. 
            Here&apos;s a breakdown of my key expertise.
          </p>
        </div>
